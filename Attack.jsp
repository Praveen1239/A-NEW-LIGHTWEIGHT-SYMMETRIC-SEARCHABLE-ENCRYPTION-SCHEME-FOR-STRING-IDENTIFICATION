...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo"> <h1 class="style10"><a href="index.html">A New Lightweight Symmetric Searchable Encryption Scheme for String Identification </a></h1>
      </div>
      <div class="clr"></div>
...
<table border="0" align="left">
	<tr>
		...
		<td>&nbsp;</td>
       	...
       	<tr>
		<td width="223" bgcolor="#FFFF00"><span class="style8 style1"><strong>Enter File Name :-</strong></span></td>
	...
	<tr>
		<td bgcolor="#FFFF00"><span class="style8 style1"><strong>Ur Name  :-</strong></span></td>
