...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><span class="style12"><a href="index.html" class="style1"><a href="index.html" class="style1"><span class="style13">A New Lightweight Symmetric Searchable Encryption Scheme for String Identification</span></a></span></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome<span class="style7"> <%=application.getAttribute("ename") %></span> <span class="style11">End User</span> Main </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="U_Search.jsp">Search String</a></li>
