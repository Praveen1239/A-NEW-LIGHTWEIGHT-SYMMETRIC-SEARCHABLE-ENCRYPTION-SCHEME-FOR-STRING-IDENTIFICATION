...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Search for String Identification <span class="style8"></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
<table width="598" border="1" align="center" cellspacing="0" cellpadding="7">
	...
	<tr>
		<td class="style4"><span class="style24">Enter Searchable String:-</span></td>
		<td><input name="keyword" type="text"></td>
	</tr>

	<tr>
		<td>&nbsp;</td>
		<td><input name="Submit" type="submit" class="style24" value="Search Data For String" /></td>
	</tr>
</table>
</form>
