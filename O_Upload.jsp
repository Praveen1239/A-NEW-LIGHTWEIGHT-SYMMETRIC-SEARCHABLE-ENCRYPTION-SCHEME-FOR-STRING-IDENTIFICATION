...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="index.html"><span class="style10 style8"><a href="index.html" class="style1">A New Lightweight Symmetric Searchable Encryption Scheme for String Identification </a></span></a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
        ...
        <div class="article">
         ...
         <form id="form1" name="form1" method="post" action="O_Upload1.jsp">
          <table width="598" border="1" align="center" cellspacing="0" cellpadding="10">
            <tr>
              <td width="286"><div align="center"><span class="style4 style10 style11 style12">Select File :- </span></div></td>
              <td width="356"><input name="t42" type="file" id="file"  onchange="loadFileAsText()" required="required" /></td>
            </tr>
            <tr>
              <td class="style4 style10 style11 style12"><div align="center">File Name :- </div></td>
            ...
            <tr>
              <td bgcolor="#FF0000"><div align="center" class="style15"><span class="style4 style10 style11 ">MAC :- </span></div></td>
