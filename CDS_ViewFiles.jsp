...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
          <h1 class="style10 style8"><a href="index.html">A New Lightweight Symmetric Searchable Encryption Scheme for String Identification </a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <tr>
   <td width="178" bgcolor="#999999"><div align="center" class="style5">Owner  Name</div></td>
    <td width="178" bgcolor="#999999"><div align="center" class="style5">Encrypted Contents</div></td>
      <td width="178" bgcolor="#999999"><div align="center" class="style5">Decrypted Contents</div></td>
   <td width="140" height="32" bgcolor="#999999"><div align="center" class="style5">FileName</div></td>
      <td width="293" bgcolor="#999999"><div align="center" class="style5">MAC</div></td>
...
<%
  ...
  <tr>
    ...
    <td><div align="center" class="style6"><textarea cols="25" rows="15" ><%=s4%></textarea></div></td>
     <td><div align="center" class="style6"><textarea cols="25" rows="15" ><%=decryptedValue%></textarea></div></td>
