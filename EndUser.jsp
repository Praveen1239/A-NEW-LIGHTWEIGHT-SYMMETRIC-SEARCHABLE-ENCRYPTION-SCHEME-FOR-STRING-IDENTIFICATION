...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style10 style8 style1"><a href="index.html" class="style2">A New Lightweight Symmetric Searchable Encryption Scheme for String Identification </a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p align="center" class="infopost"><img src="images/Login.jpg" width="309" height="138" /></p>
          <div class="clr"></div>
           <form action="userauth.jsp" method="post" id="leavereply">
            <ol>
              <li>
                <label for="name"><span class="style2">Name (required)</span></label>
                <span class="style2">
