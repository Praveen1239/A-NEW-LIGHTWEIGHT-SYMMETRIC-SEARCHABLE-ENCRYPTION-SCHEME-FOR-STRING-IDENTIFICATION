...
<div class="main">
 ...
 <td width="178" bgcolor="#46B5FF"><div align="center" class="style10 style9 style6 style14"><strong>Req Date</strong></div></td>
      <td width="178" bgcolor="#46B5FF"><div align="center" class="style10 style9 style6 style14"><strong>Res Date</strong></div></td>
       <td width="178" bgcolor="#46B5FF"><div align="center" class="style10 style9 style6 style14"><strong>MAC </strong></div></td>
...
<%
  ...
  <tr>
    ...
    <td height="29"><div align="center" class="style16"><%=s2%></div></td>
    ...
    <td><div align="center" class="style16"><%=s8%></div></td>
	  <td><div align="center" class="style17"><a href="CAS_Process.jsp?id=<%=i%>&fname=<%=s3%>&sts=<%=s9%>"><%=s9%></a></div></td>
  </tr>
