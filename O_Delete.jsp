...
.style11 {color: #FF0000; font-size: 24px; }
-->
</style>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><span class="style10 style8"><a href="index.html" class="style1">A New Lightweight Symmetric Searchable Encryption Scheme for String Identification </a></span></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
...
<p>
<h1 class="style11">Deleted SuccessFully!!!</h1>
</p>
<br />
<p><a
